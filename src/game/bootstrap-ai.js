...
function createInitialState() {
  ...
  return {
    ...
    flags: {
      ...
      ideologyConflictStarted: false,
      ideologyConflictResolved: false,
      ideologyBattleWon: false,
      ideologyBlessingApplied: false,
      ideologyMercyGranted: false,
      ideologyHintShown: false,
      ideologyFusionMaterialGranted: false,
      ideologyDevourMaterialGranted: false,
    },
    pokedex: {
      seen: {},
      caught: {},
